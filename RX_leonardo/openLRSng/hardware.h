...
const uint8_t OUTPUT_PIN[OUTPUTS] = { 3, 5, 6, 7, 8, 9, 10, 3, 12 , A4, A5, 0, 1};
...
//  #define  SDI_off PORTB &= 0xF7 //B3
 #define  SDI_on 1
  ...
  #define  SDO_1 (PINB & 0x04) == 0x01 //B4
  #define  SDO_0 (PINB & 0x04) == 0x00 //B4
...
#define Green_LED_ON   PORTE |= (1<<PORTE6);
#define Green_LED_OFF  PORTE &= ~(1<<PORTE6);
...
//const uint8_t OUTPUT_PIN[OUTPUTS] = { 3, 5, 6, 7, 8, 9, 10, 3, 12 , A4, A5, 0, 1};
const uint8_t OUTPUT_PIN[OUTPUTS] = { 3, 5, 2, 3, 8, 9, 10, 3, 12 , A4, A5, 0, 1};
